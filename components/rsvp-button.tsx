  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Switch
        ...
        onChange={rsvp}
        className={clsx(
          "group relative inline-flex h-5 w-10 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparenttransition-colors duration-200 ease-in-out focus:outline-none",
          rsvpd
